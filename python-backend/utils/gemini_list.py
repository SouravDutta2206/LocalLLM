...
def _extract_version(model_name):
...
def _get_sort_priority(model_name):
...
def get_gemini_models_list(Gemini_KEY):
    gemma_models_list = []
    gemini_models_list = []
    ...
    final_selection_data.sort(key=lambda item: (
            ...
            _get_sort_priority(item['name']), # Secondary sort key: Priority (ascending)
...
if __name__ == "__main__":
    ...
    models_list = get_gemini_models_list(Gemini_KEY=Gemini_KEY)
    print(models_list)  
